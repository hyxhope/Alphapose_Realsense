...
parser.add_argument('--cfg', type=str, required=False, default="/home/hyx/Code/AlphaPose/configs/halpe_26/resnet/256x192_res50_lr1e-3_1x.yaml",
                    help='experiment configure file name')
parser.add_argument('--checkpoint', type=str, required=False, default="/home/hyx/Code/AlphaPose/pretrained_models/halpe26_fast_res50_256x192.pth",
...
if __name__ == "__main__":
    ...
    if mode == 'webcam':
        det_loader = RealsenseDetectionLoader(input_source, get_detector(args), cfg, args)
